...
# print("{ajaxtex2} {valc2} {sac2} {timc2}")
# print({ajaxtex3} {valc3} {chgc3} {timc3}")
# print({ajaxtex4} {valc4} {sac4} {timc4}")
...
message1 = (
    ...
    "\n"
    f"日経先物 {valc0} {chgc0}\n"
    f"TOPIX先物 {valsakiV01} {chng01}\n"
    f"ﾀﾞｳ先物 {valc2} {sac2}\n"
    f"NASDAQ100先物 {valsakiV03} {chng03}\n"
    f"S＆P500先物 {val04} {chng04}
)
message2 = (
    f"半導体 {sw4} {chng4}\n"
    f"米債10年利回り {valc10} {chgc10}\n"
    f"原油 {valc7} {chgc7}\n"
    f"米VIX {valc9} {chgc9}\n"
    f"日経VIX {val02} {chng02}\n"
    f"金先物 {sw6} {chng6}\n"
    f"銅先物 {sW01} {cang00}\n"
    f"{ajaxtex6} {valc6} {chgc6}\n"
    f"ﾄﾞﾙｲﾝﾃﾞｯｸｽ {val00} {chng05}\n"
    f"{ajaxtex11} {valc11} {chgc11}"
)
